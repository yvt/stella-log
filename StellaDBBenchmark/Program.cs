	...
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			using (var stream = tmp.Open()) {
				var blocks = new StellaDB.IO.BlockFile (stream, 2048);
				var cached = new StellaDB.IO.BufferedBlockFile (blocks, 8192);
				var db = new StellaDB.LowLevel.LowLevelDatabase (cached);
